...
import type { Job, User } from '../services/database.types.ts';
import { Role, JobStatus, JobPriority } from '../services/database.types.ts';
import { Card, CardContent, Button, Modal, Input, Checkbox, Select } from './common/UI.tsx';
import { AlertTriangleIcon, BranchIcon, CheckCircleIcon, SendIcon, TruckIcon, CheckIcon, RepeatIcon } from './common/Icons.tsx';
